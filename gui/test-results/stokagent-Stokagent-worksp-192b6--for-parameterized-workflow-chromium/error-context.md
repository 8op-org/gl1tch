...
- Name: stokagent.spec.js >> Stokagent workspace — Editor >> Run button opens dialog for parameterized workflow
- Location: e2e/stokagent.spec.js:151:3
    ...
    - generic [ref=e17]:
      - navigation [ref=e18]:
        - link "Workflows" [ref=e19] [cursor=pointer]:
          - /url: /
        - generic [ref=e20]: /
        - generic [ref=e21]: issue-to-pr-claude.glitch
