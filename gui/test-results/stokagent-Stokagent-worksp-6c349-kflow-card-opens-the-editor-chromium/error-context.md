...
- Name: stokagent.spec.js >> Stokagent workspace — Editor >> clicking a workflow card opens the editor
- Location: e2e/stokagent.spec.js:120:3
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      - navigation [ref=e18]:
        - link "Workflows" [ref=e19] [cursor=pointer]:
          - /url: /
        - generic [ref=e20]: /
        - generic [ref=e21]: architecture-analysis.glitch
    ...
    - generic [ref=e26]:
      ...
      - button "Metadata" [ref=e34] [cursor=pointer]:
        - img [ref=e35]
        - text: Metadata
    - paragraph [ref=e41]: No runs yet. Click Run to execute this workflow.
```
