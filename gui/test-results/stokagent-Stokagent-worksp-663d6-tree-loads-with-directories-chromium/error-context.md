...
- Name: stokagent.spec.js >> Stokagent workspace — Results browser >> results tree loads with directories
- Location: e2e/stokagent.spec.js:174:3
...
Call log:
  - waiting for locator('.tree-item') to be visible
