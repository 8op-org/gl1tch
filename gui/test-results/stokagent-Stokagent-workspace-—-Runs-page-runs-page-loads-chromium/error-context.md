...
- Name: stokagent.spec.js >> Stokagent workspace — Runs page >> runs page loads
- Location: e2e/stokagent.spec.js:183:3
...
Locator: locator('h1').filter({ hasText: 'Runs' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: 'Runs' })
