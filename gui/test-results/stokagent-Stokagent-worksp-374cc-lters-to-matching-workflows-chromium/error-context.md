...
- Name: stokagent.spec.js >> Stokagent workspace — Workflow browsing >> search filters to matching workflows
- Location: e2e/stokagent.spec.js:90:3
  ...
  - main [ref=e16]:
    ...
    - generic [ref=e32]:
      - generic [ref=e33]:
        - generic [ref=e34]:
          - img [ref=e36]
          - textbox "Search..." [active] [ref=e39]: dashboard
        - generic [ref=e40]:
      ...
      - generic [ref=e52]:
        - button "dashboard-activity JSON feed — yesterday's authored PRs, reviews given, closed issues Never run" [ref=e53] [cursor=pointer]:
          - generic [ref=e54]:
            - img [ref=e55]
            - text: dashboard-activity
          - paragraph [ref=e57]: JSON feed — yesterday's authored PRs, reviews given, closed issues
          - generic [ref=e59]: Never run
        - button "dashboard-calendar JSON feed — today and tomorrow calendar events via gws elastic account Never run" [ref=e60] [cursor=pointer]:
          - generic [ref=e61]:
            - img [ref=e62]
            - text: dashboard-calendar
          - paragraph [ref=e64]: JSON feed — today and tomorrow calendar events via gws elastic account
          - generic [ref=e66]: Never run
        - button "dashboard-ci JSON feed — recent failed GitHub Actions runs across target repos Never run" [ref=e67] [cursor=pointer]:
          - generic [ref=e68]:
            - img [ref=e69]
            - text: dashboard-ci
          - paragraph [ref=e71]: JSON feed — recent failed GitHub Actions runs across target repos
          - generic [ref=e73]: Never run
        - button "dashboard-email JSON feed — attention-worthy unread emails via gws elastic account Never run" [ref=e74] [cursor=pointer]:
          - generic [ref=e75]:
            - img [ref=e76]
            - text: dashboard-email
          - paragraph [ref=e78]: JSON feed — attention-worthy unread emails via gws elastic account
          - generic [ref=e80]: Never run
        - button "dashboard-my-prs JSON feed — open PRs authored by adam-stokes with context and next steps Never run" [ref=e81] [cursor=pointer]:
          - generic [ref=e82]:
            - img [ref=e83]
            - text: dashboard-my-prs
          - paragraph [ref=e85]: JSON feed — open PRs authored by adam-stokes with context and next steps
          - generic [ref=e87]: Never run
        - button "dashboard-reviews JSON feed — PRs awaiting review with context and next steps Never run" [ref=e88] [cursor=pointer]:
          - generic [ref=e89]:
            - img [ref=e90]
            - text: dashboard-reviews
          - paragraph [ref=e92]: JSON feed — PRs awaiting review with context and next steps
          - generic [ref=e94]: Never run
        - button "dashboard-tasks JSON feed — prioritized tasks (HIGH/MEDIUM/LOW) with falling-behind detection Never run" [ref=e95] [cursor=pointer]:
          - generic [ref=e96]:
            - img [ref=e97]
            - text: dashboard-tasks
          - paragraph [ref=e99]: JSON feed — prioritized tasks (HIGH/MEDIUM/LOW) with falling-behind detection
