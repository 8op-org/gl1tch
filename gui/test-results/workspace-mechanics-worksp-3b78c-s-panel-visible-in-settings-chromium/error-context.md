...
- Name: workspace-mechanics.spec.js >> workspace mechanics >> resources panel visible in settings
- Location: e2e/workspace-mechanics.spec.js:62:3
...
Locator: getByRole('button', { name: /add resource/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /add resource/i })
