...
- Name: stokagent.spec.js >> Stokagent workspace — Editor >> metadata panel is visible
- Location: e2e/stokagent.spec.js:139:3
...
Call log:
  ...
  - waiting for locator('.meta-panel')
