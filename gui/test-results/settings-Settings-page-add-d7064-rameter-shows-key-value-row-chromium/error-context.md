...
- Name: settings.spec.js >> Settings page >> adding a default parameter shows key-value row
- Location: e2e/settings.spec.js:95:3
...
Locator: locator('.param-key').filter({ hasText: 'test-param' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.param-key').filter({ hasText: 'test-param' })
        ...
        - generic [ref=e31]:
          ...
          - generic [ref=e36]:
            ...
            - generic [ref=e44]:
              ...
              - generic [ref=e46]:
                - generic [ref=e47]:
                  - generic [ref=e48]: test-param
                  - textbox [ref=e49]: test-value
