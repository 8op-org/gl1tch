...
- Name: workspace-mechanics.spec.js >> workspace mechanics >> runs tree view renders
- Location: e2e/workspace-mechanics.spec.js:110:3
...
Locator: getByRole('button', { name: /^tree$/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /^tree$/i })
