...
GLITCH_CLARIFY: <your single most important question here>

Rules:
- ONE question only — pick the most critical unknown
- Output the GLITCH_CLARIFY line first, before any other text
...
DO NOT ask questions in normal prose. The GLITCH_CLARIFY format is the ONLY way to request input.
---