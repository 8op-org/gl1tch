...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__25531 = c;
var G__25531__$1 = (((G__25531 == null))?null:G__25531.prototype);
if((G__25531__$1 == null)){
return null;
} else {
return G__25531__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__25532 = c;
var G__25532__$1 = (((G__25532 == null))?null:G__25532.prototype);
if((G__25532__$1 == null)){
return null;
} else {
return G__25532__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__25622 = c;
var G__25622__$1 = (((G__25622 == null))?null:G__25622.constructor);
if((G__25622__$1 == null)){
return null;
} else {
return G__25622__$1.displayName;
}
})();
...
var G__25623 = c;
var G__25623__$1 = (((G__25623 == null))?null:G__25623.constructor);
if((G__25623__$1 == null)){
return null;
} else {
return G__25623__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__25633 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__25634 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__25634);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__25633);
}});
...
var c = this;
var G__25654_25833 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__25654_25833 == null)){
} else {
reagent.ratom.dispose_BANG_(G__25654_25833);
}
...
var renders_25841 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_25842 = cljs.core.first(cljs.core.vals(renders_25841));
...
if((cljs.core.count(renders_25841) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_25841))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_25842)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_25842], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__25664 = o;
reagent.impl.component.goog$module$goog$object.set(G__25664,cljs.core.name(k),v);
...
G__25925.cljs$lang$applyTo = (function (arglist__25929){
...
var _STAR_current_component_STAR__orig_val__25708 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__25709 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__25709);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__25708);
}});
...
var vec__25714 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25714,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25714,(1),null);
...
var G__25717 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__25717 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__25717);
}
});
}),[]);
