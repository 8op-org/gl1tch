...
var G__25967 = o;
reagent.impl.template.goog$module$goog$object.set(G__25967,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__26003 = o;
reagent.impl.template.goog$module$goog$object.set(G__26003,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__26016 = props;
var G__26016__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26016,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26016);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26016__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26020 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26020,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26020;
}
})(),id_class);
...
var G__26025 = (cljs.core.count(argv) - first_child);
switch (G__26025) {
case (0):
...
var vec__26038 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26038,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26038,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26038,(2),null);
...
var temp__5829__auto___26214 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___26214 == null)){
} else {
var key_26215 = temp__5829__auto___26214;
(jsprops.key = key_26215);
}
...
var temp__5829__auto___26216 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___26216 == null)){
} else {
var key_26217 = temp__5829__auto___26216;
(jsprops.key = key_26217);
}
...
var temp__5829__auto___26218 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___26218 == null)){
} else {
var key_26219 = temp__5829__auto___26218;
...
var temp__5829__auto___26222 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___26222 == null)){
} else {
var key_26223 = temp__5829__auto___26222;
(jsprops.key = key_26223);
}
...
var temp__5829__auto___26224 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___26224 == null)){
} else {
var key_26225 = temp__5829__auto___26224;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26049_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26049_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26058 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26058,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26058,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template26143 = (function (opts,id,fn_to_element,parse_fn,meta26144){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26143.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26145,meta26144__$1){
var self__ = this;
var _26145__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26143(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26144__$1));
}));

(reagent.impl.template.t_reagent$impl$template26143.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26145){
var self__ = this;
var _26145__$1 = this;
return self__.meta26144;
}));

(reagent.impl.template.t_reagent$impl$template26143.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26143.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26143.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26143.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26143.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26143.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26144","meta26144",2090363386,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26143.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26143.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26143");

(reagent.impl.template.t_reagent$impl$template26143.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template26143");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26143.
 */
reagent.impl.template.__GT_t_reagent$impl$template26143 = (function reagent$impl$template$__GT_t_reagent$impl$template26143(opts,id,fn_to_element,parse_fn,meta26144){
return (new reagent.impl.template.t_reagent$impl$template26143(opts,id,fn_to_element,parse_fn,meta26144));
});
...
return (new reagent.impl.template.t_reagent$impl$template26143(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
