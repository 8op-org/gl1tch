...
var G__24611 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__24611,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__24611;
}
}));
...
var len__5726__auto___24746 = arguments.length;
var i__5727__auto___24747 = (0);
while(true){
if((i__5727__auto___24747 < len__5726__auto___24746)){
args__5732__auto__.push((arguments[i__5727__auto___24747]));

var G__24748 = (i__5727__auto___24747 + (1));
i__5727__auto___24747 = G__24748;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq24618){
var G__24619 = cljs.core.first(seq24618);
var seq24618__$1 = cljs.core.next(seq24618);
var G__24620 = cljs.core.first(seq24618__$1);
var seq24618__$2 = cljs.core.next(seq24618__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24619,G__24620,seq24618__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24630__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24630__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24630__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24629_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__24629_SHARP_));
...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__24632 = cljs.core.get_global_hierarchy;
return (fexpr__24632.cljs$core$IFn$_invoke$arity$0 ? fexpr__24632.cljs$core$IFn$_invoke$arity$0() : fexpr__24632.call(null, ));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__24633 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__24633) : formatter_fn.call(null, G__24633));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__24634 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
...
var temp__5825__auto___24759 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___24759)){
var message_24760 = temp__5825__auto___24759;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_24760], 0));
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__24646 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__24646,"/"].join('');
} else {
return G__24646;
}
})();
...
var temp__5823__auto__ = (function (){var and__5000__auto__ = typeof exception.stack === 'string';
...
var vec__24658 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24658,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24658,(1),null);
var vec__24661 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24661,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24661,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24661,(2),null);
...
var G__24675 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6385__auto__,temp__5825__auto__){
return (function (){
var G__24685 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__24685) : cljs.test.run_block.call(null, G__24685));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__24675) : obj.call(null, G__24675));
} else {
var G__24804 = (function (){var G__24688 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__24688);
} else {
return G__24688;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__24691,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__24705 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24705,(0),null);
var types = vec__24705;
...
var fexpr__24717 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946)], null);
return (fexpr__24717.cljs$core$IFn$_invoke$arity$2 ? fexpr__24717.cljs$core$IFn$_invoke$arity$2(type,new cljs.core.Keyword(null,"async","async",1050769601)) : fexpr__24717.call(null, type,new cljs.core.Keyword(null,"async","async",1050769601)));
});
...
var G__24728 = (function (){
var seq__24729 = cljs.core.seq(vars__$1);
var chunk__24730 = null;
var count__24731 = (0);
var i__24732 = (0);
while(true){
if((i__24732 < count__24731)){
var v = chunk__24730.cljs$core$IIndexed$_nth$arity$2(null, i__24732);
var temp__5825__auto___24853 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5825__auto___24853)){
var t_24857 = temp__5825__auto___24853;
var G__24736_24858 = ((function (seq__24729,chunk__24730,count__24731,i__24732,t_24857,temp__5825__auto___24853,v,each_fixture_fn,G__24726,G__24726__$1,env,once_fixtures,each_fixtures,vec__24723,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_24857)));
});})(seq__24729,chunk__24730,count__24731,i__24732,t_24857,temp__5825__auto___24853,v,each_fixture_fn,G__24726,G__24726__$1,env,once_fixtures,each_fixtures,vec__24723,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__24736_24858) : each_fixture_fn.call(null, G__24736_24858));
} else {
}


var G__24859 = seq__24729;
var G__24860 = chunk__24730;
var G__24861 = count__24731;
var G__24862 = (i__24732 + (1));
seq__24729 = G__24859;
chunk__24730 = G__24860;
count__24731 = G__24861;
i__24732 = G__24862;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__24729);
if(temp__5825__auto__){
var seq__24729__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24729__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__24729__$1);
var G__24863 = cljs.core.chunk_rest(seq__24729__$1);
var G__24864 = c__5525__auto__;
var G__24865 = cljs.core.count(c__5525__auto__);
var G__24866 = (0);
seq__24729 = G__24863;
chunk__24730 = G__24864;
count__24731 = G__24865;
i__24732 = G__24866;
continue;
} else {
var v = cljs.core.first(seq__24729__$1);
var temp__5825__auto___24871__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5825__auto___24871__$1)){
var t_24872 = temp__5825__auto___24871__$1;
var G__24737_24873 = ((function (seq__24729,chunk__24730,count__24731,i__24732,t_24872,temp__5825__auto___24871__$1,v,seq__24729__$1,temp__5825__auto__,each_fixture_fn,G__24726,G__24726__$1,env,once_fixtures,each_fixtures,vec__24723,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_24872)));
});})(seq__24729,chunk__24730,count__24731,i__24732,t_24872,temp__5825__auto___24871__$1,v,seq__24729__$1,temp__5825__auto__,each_fixture_fn,G__24726,G__24726__$1,env,once_fixtures,each_fixtures,vec__24723,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__24737_24873) : each_fixture_fn.call(null, G__24737_24873));
} else {
}


var G__24874 = cljs.core.next(seq__24729__$1);
var G__24875 = null;
var G__24876 = (0);
var G__24877 = (0);
seq__24729 = G__24874;
chunk__24730 = G__24875;
count__24731 = G__24876;
i__24732 = G__24877;
continue;
}
} else {
...
var fexpr__24727 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__24727.cljs$core$IFn$_invoke$arity$1 ? fexpr__24727.cljs$core$IFn$_invoke$arity$1(G__24728) : fexpr__24727.call(null, G__24728));
})], null);
