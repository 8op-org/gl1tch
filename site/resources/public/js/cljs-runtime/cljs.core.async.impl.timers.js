...
var i_30881 = (self__.level + (1));
while(true){
if((i_30881 <= (new_level + (1)))){
(update[i_30881] = self__.header);

var G__30882 = (i_30881 + (1));
i_30881 = G__30882;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30883 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30883[i]));
} else {
x__$2.forward.push((((i < links_30883.length))?(links_30883[i]):null));
}

if((i < links_30883.length)){
(links_30883[i] = x__$2);
} else {
links_30883.push(x__$2);
}
...
var links_30903 = (update[i_30900]).forward;
if((x__$1 === (((i_30900 < links_30903.length))?(links_30903[i_30900]):null))){
(links_30903[i_30900] = (x__$1.forward[i_30900]));

var G__30905 = (i_30900 + (1));
i_30900 = G__30905;
continue;
} else {
var G__30906 = (i_30900 + (1));
i_30900 = G__30906;
continue;
}
} else {
