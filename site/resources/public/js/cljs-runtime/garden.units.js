 ...
 */
garden.units.convert = (function garden$units$convert(p__42052,right){
var map__42053 = p__42052;
var map__42053__$1 = cljs.core.__destructure_map(map__42053);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42053__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42053__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__42054 = temp__5825__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42054,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42054,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42054,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42057__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42058 = u(y);
var map__42058__$1 = cljs.core.__destructure_map(map__42058);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42058__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__42082__delegate = function (x,y,more){
...
var G__42082 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42083__i = 0, G__42083__a = new Array(arguments.length -  2);
while (G__42083__i < G__42083__a.length) {G__42083__a[G__42083__i] = arguments[G__42083__i + 2]; ++G__42083__i;}
  more = new cljs.core.IndexedSeq(G__42083__a,0,null);
} 
return G__42082__delegate.call(this,x,y,more);};
G__42082.cljs$lang$maxFixedArity = 2;
G__42082.cljs$lang$applyTo = (function (arglist__42084){
var x = cljs.core.first(arglist__42084);
arglist__42084 = cljs.core.next(arglist__42084);
var y = cljs.core.first(arglist__42084);
var more = cljs.core.rest(arglist__42084);
return G__42082__delegate(x,y,more);
});
...
var G__42085 = null;
if (arguments.length > 2) {
var G__42086__i = 0, G__42086__a = new Array(arguments.length -  2);
while (G__42086__i < G__42086__a.length) {G__42086__a[G__42086__i] = arguments[G__42086__i + 2]; ++G__42086__i;}
G__42085 = new cljs.core.IndexedSeq(G__42086__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42085);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42059__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42060 = u(y);
var map__42060__$1 = cljs.core.__destructure_map(map__42060);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42060__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__42087__delegate = function (x,y,more){
...
var G__42087 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42091__i = 0, G__42091__a = new Array(arguments.length -  2);
while (G__42091__i < G__42091__a.length) {G__42091__a[G__42091__i] = arguments[G__42091__i + 2]; ++G__42091__i;}
  more = new cljs.core.IndexedSeq(G__42091__a,0,null);
} 
return G__42087__delegate.call(this,x,y,more);};
G__42087.cljs$lang$maxFixedArity = 2;
G__42087.cljs$lang$applyTo = (function (arglist__42092){
...
return G__42087__delegate(x,y,more);
});
...
var G__42094 = null;
if (arguments.length > 2) {
var G__42095__i = 0, G__42095__a = new Array(arguments.length -  2);
while (G__42095__i < G__42095__a.length) {G__42095__a[G__42095__i] = arguments[G__42095__i + 2]; ++G__42095__i;}
G__42094 = new cljs.core.IndexedSeq(G__42095__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42094);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42061__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42062 = u(y);
var map__42062__$1 = cljs.core.__destructure_map(map__42062);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42062__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__42096__delegate = function (x,y,more){
...
var G__42096 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42097__i = 0, G__42097__a = new Array(arguments.length -  2);
while (G__42097__i < G__42097__a.length) {G__42097__a[G__42097__i] = arguments[G__42097__i + 2]; ++G__42097__i;}
  more = new cljs.core.IndexedSeq(G__42097__a,0,null);
} 
return G__42096__delegate.call(this,x,y,more);};
G__42096.cljs$lang$maxFixedArity = 2;
...
return G__42096__delegate(x,y,more);
});
...
var G__42099 = null;
if (arguments.length > 2) {
var G__42100__i = 0, G__42100__a = new Array(arguments.length -  2);
while (G__42100__i < G__42100__a.length) {G__42100__a[G__42100__i] = arguments[G__42100__i + 2]; ++G__42100__i;}
G__42099 = new cljs.core.IndexedSeq(G__42100__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42099);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42063__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__42064 = u(y);
var map__42064__$1 = cljs.core.__destructure_map(map__42064);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42064__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null, m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__42102__delegate = function (x,y,more){
...
var G__42102 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__42103__i = 0, G__42103__a = new Array(arguments.length -  2);
while (G__42103__i < G__42103__a.length) {G__42103__a[G__42103__i] = arguments[G__42103__i + 2]; ++G__42103__i;}
  more = new cljs.core.IndexedSeq(G__42103__a,0,null);
} 
return G__42102__delegate.call(this,x,y,more);};
G__42102.cljs$lang$maxFixedArity = 2;
G__42102.cljs$lang$applyTo = (function (arglist__42104){
var x = cljs.core.first(arglist__42104);
arglist__42104 = cljs.core.next(arglist__42104);
var y = cljs.core.first(arglist__42104);
var more = cljs.core.rest(arglist__42104);
return G__42102__delegate(x,y,more);
});
G__42102.cljs$core$IFn$_invoke$arity$variadic = G__42102__delegate;
return G__42102;
})()
;
...
var G__42105 = null;
if (arguments.length > 2) {
var G__42106__i = 0, G__42106__a = new Array(arguments.length -  2);
while (G__42106__i < G__42106__a.length) {G__42106__a[G__42106__i] = arguments[G__42106__i + 2]; ++G__42106__i;}
G__42105 = new cljs.core.IndexedSeq(G__42106__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__42105);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
