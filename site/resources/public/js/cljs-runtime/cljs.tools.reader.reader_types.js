...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41248 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41248(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41250 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41250(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41251 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41251(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41253 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41253(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41254 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41254(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41255 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41255(reader);
}
});
...
var G__41297 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__41298 = s.append(c);
c = G__41297;
s = G__41298;
continue;
}
