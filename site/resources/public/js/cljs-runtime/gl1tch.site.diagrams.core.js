...
var in_map = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__41640){
var vec__41641 = p__41640;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41641,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41641,(1),null);
...
,cljs.core.get.cljs$core$IFn$_invoke$arity$3(in_map,p1__41636_SHARP_,cljs.core.PersistentHashSet.EMPTY));
});})(remaining,layers,ids,in_map))
,remaining);
if(cljs.core.empty_QMARK_(ready)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(layers,cljs.core.vec(remaining));
} else {
var G__41672 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.disj,remaining,ready);
var G__41673 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(layers,ready);
remaining = G__41672;
layers = G__41673;
continue;
}
...
var vec__41645 = gl1tch.site.diagrams.core.node_center(from_node);
var fx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41645,(0),null);
var fy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41645,(1),null);
var vec__41648 = gl1tch.site.diagrams.core.node_center(to_node);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41648,(0),null);
var ty = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41648,(1),null);
 ...
 *          :width :height}
 */
gl1tch.site.diagrams.core.compute = (function gl1tch$site$diagrams$core$compute(p__41655){
var map__41656 = p__41655;
var map__41656__$1 = cljs.core.__destructure_map(map__41656);
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41656__$1,new cljs.core.Keyword(null,"direction","direction",-633359395),new cljs.core.Keyword(null,"lr","lr",445647393));
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41656__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var edges = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41656__$1,new cljs.core.Keyword(null,"edges","edges",-694791395));
...
var positioned = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__41657){
var vec__41658 = p__41657;
var layer_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41658,(0),null);
var layer = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41658,(1),null);
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc2,p__41661){
var vec__41662 = p__41661;
var pos_in_layer = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41662,(0),null);
var node_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41662,(1),null);
...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41665,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41665,(1),null);
...
var edge_results = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__41668){
var vec__41669 = p__41668;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41669,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41669,(1),null);
...
var max_x = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41653_SHARP_){
return (new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(p1__41653_SHARP_) + new cljs.core.Keyword(null,"w","w",354169001).cljs$core$IFn$_invoke$arity$1(p1__41653_SHARP_));
}),all_nodes));
var max_y = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41654_SHARP_){
return (new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(p1__41654_SHARP_) + new cljs.core.Keyword(null,"h","h",1109658740).cljs$core$IFn$_invoke$arity$1(p1__41654_SHARP_));
}),all_nodes));
