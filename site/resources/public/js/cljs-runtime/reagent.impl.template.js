...
var G__38479 = o;
reagent.impl.template.goog$module$goog$object.set(G__38479,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__38588__delegate = function (args){
...
while (G__38589__i < G__38589__a.length) {G__38589__a[G__38589__i] = arguments[G__38589__i + 0]; ++G__38589__i;}
  args = new cljs.core.IndexedSeq(G__38589__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38590);
...
var G__38487 = o;
reagent.impl.template.goog$module$goog$object.set(G__38487,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__38497 = props;
var G__38497__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38497,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38497);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38497__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38498 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38498,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38498;
}
})(),id_class);
...
var G__38499 = (cljs.core.count(argv) - first_child);
switch (G__38499) {
case (0):
...
var vec__38502 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38502,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38502,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38502,(2),null);
...
var temp__5829__auto___38598 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38598 == null)){
} else {
var key_38599 = temp__5829__auto___38598;
(jsprops.key = key_38599);
}
...
var temp__5829__auto___38613 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38613 == null)){
} else {
var key_38615 = temp__5829__auto___38613;
(jsprops.key = key_38615);
}
...
var temp__5829__auto___38628 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___38628 == null)){
} else {
var key_38629 = temp__5829__auto___38628;
(jsprops.key = key_38629);
}
...
var temp__5829__auto___38630 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38630 == null)){
} else {
var key_38631 = temp__5829__auto___38630;
(jsprops.key = key_38631);
}
...
var temp__5829__auto___38632 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38632 == null)){
} else {
var key_38633 = temp__5829__auto___38632;
(jsprops.key = key_38633);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38540_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38540_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38546 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38546,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38546,(1),null);
...
break;
default:
var G__38640 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38641 = compiler;
v = G__38640;
compiler = G__38641;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template38561 = (function (opts,id,fn_to_element,parse_fn,meta38562){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38561.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38563,meta38562__$1){
var self__ = this;
var _38563__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38561(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38562__$1));
}));

(reagent.impl.template.t_reagent$impl$template38561.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38563){
var self__ = this;
var _38563__$1 = this;
return self__.meta38562;
}));

(reagent.impl.template.t_reagent$impl$template38561.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38561.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38561.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38561.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38561.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38561.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38562","meta38562",253854871,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38561.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38561.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38561");

(reagent.impl.template.t_reagent$impl$template38561.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template38561");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38561.
 */
reagent.impl.template.__GT_t_reagent$impl$template38561 = (function reagent$impl$template$__GT_t_reagent$impl$template38561(opts,id,fn_to_element,parse_fn,meta38562){
return (new reagent.impl.template.t_reagent$impl$template38561(opts,id,fn_to_element,parse_fn,meta38562));
});
...
return (new reagent.impl.template.t_reagent$impl$template38561(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
